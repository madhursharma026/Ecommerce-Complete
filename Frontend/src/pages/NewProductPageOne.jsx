        ...
        <div className="container-xl py-4">
            <div className="row pt-3 pt-3">
                ...
                <div className="col-lg-6 px-3 pt-3">
                    <h3>Pure Buffalo Ghee</h3>
                    <div className="row py-1">
                        <div className="col">
                            <Link to="/" className="text-success" style={{ fontSize: "14px" }}>Pure Buffalo Ghee</Link>&nbsp;
                        </div>
                    ...
                    <p className="text-muted pt-2">
                        Delicious ghee ethically prepared from enzyme-rich yoghurt of pure breed buffalos
                    </p>
                    <div className="mt-2">
                    ...
                    <div className="mt-5" style={{ maxWidth: "600px" }}>
                        ...
                        <div className="d-flex align-items-center justify-content-start gap-3">
                            <div className="col-6 col-xl-4">
                                <button type="button" class="btn btn-success w-100" onClick={() => dispatch(BuffaloGheeincrement())}>Add to Cart</button>
                            </div>
                            <div className="col-6 col-xl-4">
                                <button type="button" class="btn btn-primary w-100" onClick={() => (dispatch(BuffaloGheeincrement()), navigate("/add_to_cart"))}>Buy Now</button>
                            </div>
            ...
            <div className="mx-xl-5 believe_car_before_md_scrn pt-5">
                <div className="d-flex justify-content-center align-items-center flex-column">
                    ...
                    <span>Why Ghee Wala’ Buffalo Ghee </span>
                </div>
            ...
            <div className="videoSection py-5">
                ...
                <video width="100%" controls autoplay>
                    <source src="https://youtu.be/_1ZcIM9O2cI" />
            ...
            <div className="text-center my-5">
                ...
                <p>
                    Buffalo Ghee is a healthy fat that contains Omega-3 and 6, along with other vitamins like A, D and K. It is absorbed in the same rate as carbs or sugars (and hence does not make you gain weight) just like coconut oil yet it helps in maintaining strong appetites by secreting gastric acid. Ghee also protects your brain from neurological disorders including Alzheimer's disease and dementia which makes it an all-around essential food for everyday living
                </p>
                <p>
                    Buffalo Ghee is given to children from the first food after mother's milk. It has a neutralising effect on the stomach acid and makes it easier for them to digest other foods as they grow up. This way, buffalo ghee helps kids maintain their health and nutrition throughout their lives by adding nutrients that come from grass-fed bison without using any machinery or additives! At Ghee Wala, we offer pure organic buffalo ghee with no adulterants at all! Our original Buffalo Ghee comes from small family farms in our village using traditional methods such as hand grinding of spices instead of industrial production machines. The freshness of real Indian Buffalo Ghee will make anyone mesmerised with its taste - even adults who have grown accustomed to commercial products!!
                </p>
            </div>
...
export default NewProductPageOne;
