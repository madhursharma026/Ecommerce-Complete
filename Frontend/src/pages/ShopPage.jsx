            ...
            <div className="container-xl py-5">
                <div className="row pb-5 px-lg-5">
                    <div className="col-md-4 mt-3 py-3" style={{ background: "#EAEAEA" }}>
                        ...
                        <hr />
                        <input type="radio" /><span style={{ fontWeight: "500" }}>&ensp;BOYS</span><br />
                        <input type="radio" /><span style={{ fontWeight: "500" }}>&ensp;GIRLS</span>
                        <hr />
                        <div className="row">
                            <div className="col">
                                <h6>CATEGORIES</h6>
                        ...
                        <input type="checkbox" /><span style={{ fontWeight: "500" }}>&ensp;Dresses(156789)</span><br />
                        <input type="checkbox" /><span style={{ fontWeight: "500" }}>&ensp;Dresses(156789)</span><br />
                        <input type="checkbox" /><span style={{ fontWeight: "500" }}>&ensp;Dresses(156789)</span><br />
                        <input type="checkbox" /><span style={{ fontWeight: "500" }}>&ensp;Dresses(156789)</span><br />
                        <input type="checkbox" /><span style={{ fontWeight: "500" }}>&ensp;Dresses(156789)</span><br />
