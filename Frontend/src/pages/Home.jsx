        ...
        <>
            ...
            <div className="container-xl py-5">
                ...
                <div className="content">
                    ...
                    <h5 className="pt-3 text-uppercase"><u>Indulge In The Season’s Finest</u></h5>
                    <div>
                        <p>
                    ...
                    <h5 className="pt-3 text-uppercase"><u>Feel A Burst Of Energy</u></h5>
                    <p>
                ...
                <div className="content py-5">
                    ...
                    <div>
                        <h5 className="pt-3"><u>INDIA'S FIRST 100% TRANSPARENT PROCUREMENT TEA PROCESS</u></h5>
                        <p className="">Being just an hour and a half away from the iconic tea gardens of the world, we have devised a unique tea sourcing process. We procure teas within 24-48 hrs of sampling and keep them under <b>3-4% moisture levels.</b> Next, we hand sort & clean whole leaves for impurities, <b>vacuum pack,</b> and store them under controlled environment.</p>
                        <h5 className="pt-3"><u>WE ARE DISRUPTING A 200-YEAR-OLD TEA INDUSTRY</u></h5>
                        <p className="">From <b>leaf to cup, fresh in 7 days,</b> we connect tea to all tea lovers.</p>
                    </div>
                </div>
                <div className="row mt-md-5 g-3">
                    <div className="col-md-6 ">
                        <div className="text-center border" style={{ background: "#F5F5F5" }}>
            ...
            <div className="mx-3 pt-5 content">
                <div className="container-xl text-center p-5" style={{ background: "#339340", borderRadius: "10px" }}>
                    ...
                    <h3 className="text-light fw-bold pt-4">OUR COMMITMENT TO PLANET EARTH</h3>
            ...
            <h3 className="pt-5 text-center py-4 main_heading fw-bold">WHAT PEOPLE<span className="text-success">&nbsp;ARE SAYING </span></h3>
                        ...
                        <div class="accordion-item" style={{ border: "0" }}>
                            <h2 class="accordion-header" id="flush-headingOne">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                                    <p className="px-3 px-lg-5 m-0" style={{ fontSize: "22px", lineHeight: "33px" }}>Do you expect me to pay this much when I can get the same tea at reduced prices from other brands?</p>
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item" style={{ border: "0" }}>
                            <h2 class="accordion-header" id="flush-headingTwo">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
                                    <p className="px-3 px-lg-5 m-0" style={{ fontSize: "22px", lineHeight: "33px" }}>Where do you ship and pack your teas from?</p>
                                </button>
                            </h2>
