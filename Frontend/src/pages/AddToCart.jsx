...
import { CheckoutDone } from "../Redux/EcommerceReducer";
                    ...
                    <div className="row pb-5">
                        ...
                        <div className="col-lg-6 item_details px-4 order-1 order-lg-2">
                            <div className="container container-lg-fluid">
                                <h3 className=""><b>Cart({TotalQty})</b></h3>
                                {
                                    BuffaloGheeQty >= 1 ?
                                ...
                                <div className="row py-5 ">
                                    ...
                                    <div className="col-6 pt-2" style={{ float: "right" }}>
                                        <h6><button type="button" class="btn btn-success" onClick={() => placeOrderSubmit()}>Checkout</button></h6>
                                    </div>
